                ...
                <div className="chatBox">
                    ...
                    <div className="chatBody" id="chatBody">
                        {/* <div className="chat_other">
                            <div className="chat_img">
                                <img src="https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1007923841,2418143080&fm=26&gp=0.jpg"/>
                            </div>
                            <div>
                                <p className="chat_name">a123</p>
                        ...
                        <div className="chat_self">
                            <div>
                                <p className="chat_name">asd</p>
                                <div className="chat_msg">
                                    h
                                </div>
                            </div>
                            <div className="chat_img"><img src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1235408669,1544530317&fm=26&gp=0.jpg"/></div>
                        </div> */}
                    </div>
                    <div className="chatFooter">
                        ...
                        <div className="chat_bt">
                            ...
                            <button className="btn btn-raised btn-primary chat_btchild" onClick={()=>this.send()}>send</button>
                        </div>
                    </div>
                </div>
            </div>
